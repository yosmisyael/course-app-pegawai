...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-primary text-white flex-col hidden md:flex overflow-y-auto">
        ...
        <div class="h-20 flex items-center justify-center flex-shrink-0">
            <a href="index.html" class="text-3xl font-bold text-white">Teamable</a>
        </div>

        <!-- Navigation -->
        <nav class="flex-1 px-4 py-4 space-y-2">
            <a href="dashboard.html" class="flex items-center px-4 py-3 rounded-lg bg-secondary text-white font-medium">
                <!-- Heroicon: home -->
                <svg class="w-6 h-6 mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <path d="M12 5.432l8.25 8.25v.011a.75.75 0 010 1.06l-1.125 1.125a.75.75 0 01-1.06 0l-1.28-1.28v5.188a.75.75 0 01-.75.75h-3a.75.75 0 01-.75-.75v-2.25a.75.75 0 00-.75-.75h-1.5a.75.75 0 00-.75.75v2.25a.75.75 0 01-.75.75h-3a.75.75 0 01-.75-.75v-5.187l-1.282 1.28a.75.75 0 01-1.06 0l-1.125-1.125a.75.75 0 010-1.06l.011-.01L12 5.43z" />
                </svg>
                Dashboard
            </a>
            <a href="#" class="flex items-center px-4 py-3 rounded-lg text-tertiary hover:bg-primary/50 hover:text-white font-medium">
            ...
            <a href="#" class="flex items-center px-4 py-3 rounded-lg text-tertiary hover:bg-primary/50 hover:text-white font-medium">
                ...
                <svg class="w-6 h-6 mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    <path fill-rule="evenodd" d="M14.615 1.595a.75.75 0 01.359.852L12.982 9.75h7.268a.75.75 0 01.548 1.262l-10.5 11.25a.75.75 0 01-1.272-.728l2.965-7.02H4.5a.75.75 0 01-.548-1.262l10.5-11.25a.75.75 0 01.913-.145z" clip-rule="evenodd" />
                </svg>
                Payroll
            </a>
            <a href="#" class="flex items-center px-4 py-3 rounded-lg text-tertiary hover:bg-primary/50 hover:text-white font-medium">
                ...
                <svg class="w-6 h-6 mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    <path fill-rule="evenodd" d="M4.5 2.25a.75.75 0 000 1.5v16.5a.75.75 0 00.75.75h13.5a.75.75 0 00.75-.75V3.75a.75.75 0 000-1.5H4.5zM8.25 6a.75.75 0 000 1.5h.008a.75.75 0 000-1.5H8.25zM8.25 9a.75.75 0 000 1.5h.008a.75.75 0 000-1.5H8.25zM8.25 12a.75.75 0 000 1.5h.008a.75.75 0 000-1.5H8.25zM8.25 15a.75.75 0 000 1.5h.008a.75.75 0 000-1.5H8.25zM10.5 6a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5zM10.5 9a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5zM10.5 12a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5zM10.5 15a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5z" clip-rule="evenodd" />
                </svg>
                Organization
            </a>
            <a href="#" class="flex items-center px-4 py-3 rounded-lg text-tertiary hover:bg-primary/50 hover:text-white font-medium">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <!-- Top Navigation -->
        <header class="h-20 bg-white shadow-sm flex items-center justify-between px-6 flex-shrink-0">
